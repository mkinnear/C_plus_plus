...
namespace Gameengine {
	...
	IGameScreen* Gameengine::ScreenList::moveNext() {
	...
	IGameScreen* Gameengine::ScreenList::movePrevious() {
		IGameScreen* currentScreen = getCurrent();
	...
	void Gameengine::ScreenList::setScreen(int nextScreen) {
		m_currentScreenIndex = nextScreen;
	}

	void Gameengine::ScreenList::addScreen(IGameScreen* newScreen) {
	...
	void Gameengine::ScreenList::destroy() {
